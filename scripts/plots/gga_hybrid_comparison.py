...
def plot():
    ...
    ax[0].text(1,1.06,r'$\mathrm{RMSE=%.2f}$ eV' % np.sqrt(np.mean((Ead_hybrid-Ead_gga)**2)), horizontalalignment='right',
    ...
    ax[1].text(1,1.06,r'$\mathrm{RMSE=%.2f}$ eV' % np.sqrt(np.mean((Egap_hybrid-Egap_gga)**2)), horizontalalignment='right',
    ...
    ax[2].text(1,1.06,r'$\mathrm{RMSE=%.2f}$ e' % np.sqrt(np.mean((q_hybrid-q_gga)**2)), horizontalalignment='right',
    ...
    ax[3].text(1,1.06,r'$\mathrm{RMSE=%.2f}$ $\mu_\mathrm{B}$' % np.sqrt(np.mean((mu_hybrid-mu_gga)**2)), horizontalalignment='right',
