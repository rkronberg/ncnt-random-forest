...
def main():
    ...
    # Get H2 energy
    str1 = "grep 'ENERGY|' %s/hybrid_refs/H2/h2-geoopt.out | tail -1 | awk '{print $9}'" % CP2K_OUT_PATH
    h2Ener = float(subprocess.check_output(str1,shell=True))

    # Dictionary of systems and number of hydrogen configurations
    dirs = {'1N_1H_14x0_graphitic': 3,
            '1N_1H_14x0_pyridinic': 3,
            '1N_1H_14x0_pyrrolic': 3,
            '1N_1H_14x0_pyrrolic_SW_A': 3,
            '1N_1H_14x0_pyrrolic_SW_B': 3,
            '2N_1H_14x0_graphitic': 3,
            '3N_1H_14x0_pyridinic': 3,
            '4N_1H_14x0_pyridinic': 3,
            '1N_1H_8x8_graphitic': 3,
            '1N_1H_8x8_pyridinic': 3,
            '1N_1H_8x8_pyrrolic': 3,
            '1N_1H_8x8_pyrrolic_SW_A': 3,
            '1N_1H_8x8_pyrrolic_SW_B': 3,
            '2N_1H_8x8_graphitic': 3,
            '3N_1H_8x8_pyridinic': 3,
            '4N_1H_8x8_pyridinic': 3,
            '1N_2H_14x0_graphitic': 3,
            '1N_2H_14x0_pyridinic': 3,
            '1N_2H_14x0_pyrrolic': 3,
            '1N_2H_14x0_pyrrolic_SW_A': 3,
            '1N_2H_14x0_pyrrolic_SW_B': 3,
            '2N_2H_14x0_graphitic': 3,
            '3N_2H_14x0_pyridinic': 3,
            '4N_2H_14x0_pyridinic': 3,
            '1N_2H_8x8_graphitic': 3,
            '1N_2H_8x8_pyridinic': 3,
            '1N_2H_8x8_pyrrolic': 3,
            '1N_2H_8x8_pyrrolic_SW_A': 3,
            '1N_2H_8x8_pyrrolic_SW_B': 3,
            '2N_2H_8x8_graphitic': 3,
            '3N_2H_8x8_pyridinic': 3,
            '4N_2H_8x8_pyridinic': 3,
            '1N_3H_14x0_graphitic': 3,
            '1N_3H_14x0_pyridinic': 3,
            '1N_3H_14x0_pyrrolic': 3,
            '1N_3H_14x0_pyrrolic_SW_A': 3,
            '1N_3H_14x0_pyrrolic_SW_B': 3,
            '2N_3H_14x0_graphitic': 3,
            '3N_3H_14x0_pyridinic': 3,
            '4N_3H_14x0_pyridinic': 3,
            '1N_3H_8x8_graphitic': 3,
            '1N_3H_8x8_pyridinic': 3,
            '1N_3H_8x8_pyrrolic': 3,
            '1N_3H_8x8_pyrrolic_SW_A': 3,
            '1N_3H_8x8_pyrrolic_SW_B': 3,
            '2N_3H_8x8_graphitic': 3,
            '3N_3H_8x8_pyridinic': 3,
            '4N_3H_8x8_pyridinic': 3,
            '1N_4H_14x0_graphitic': 3,
            '1N_4H_14x0_pyridinic': 3,
            '1N_4H_14x0_pyrrolic': 3,
            '1N_4H_14x0_pyrrolic_SW_A': 3,
            '1N_4H_14x0_pyrrolic_SW_B': 3,
            '2N_4H_14x0_graphitic': 3,
            '3N_4H_14x0_pyridinic': 3,
            '4N_4H_14x0_pyridinic': 3,
            '1N_4H_8x8_graphitic': 3,
            '1N_4H_8x8_pyridinic': 3,
            '1N_4H_8x8_pyrrolic': 3,
            '1N_4H_8x8_pyrrolic_SW_A': 3,
            '1N_4H_8x8_pyrrolic_SW_B': 3,
            '2N_4H_8x8_graphitic': 3,
            '3N_4H_8x8_pyridinic': 3,
            '4N_4H_8x8_pyridinic': 3
    }
    ...
    for d in tqdm(dirs):
        ...
        str2 = "grep 'ENERGY|' %s/hybrid_refs/%s/ncnt-geoopt.out | tail -1 | awk '{print $9}'" \
            % (CP2K_OUT_PATH,d)
        refEner = float(subprocess.check_output(str2,shell=True))

        # Optimized reference
        refopt = read('%s/hybrid_refs/%s/ncnt.xyz' % (CP2K_OUT_PATH,d))
        cell = refopt.get_cell()
        ...
        for c in tqdm(range(dirs[d]+1),leave=False):
            str3 = "grep 'ENERGY|' %s/hybrid_adsorbed/%s/ncnt_%s-geoopt.out | tail -1 | awk '{print $9}'" \
                % (CP2K_OUT_PATH,d,c)
            ...
            xyz = read('%s/hybrid_adsorbed/%s/ncnt_%s.xyz' % (CP2K_OUT_PATH,d,c))
            xyz.set_cell(cell)
            ...
            str4 = "grep ' %s       %s' %s/hybrid_refs/%s/ncnt-geoopt.out | tail -1 | awk '{print $8}'" \
                % (site+1,xyz.symbols[site], CP2K_OUT_PATH, d)
            nac = float(subprocess.check_output(str4,shell=True))
            q.append(nac)

            # Spin moment on adsorption site
            str5 = "grep ' %s       %s' %s/hybrid_refs/%s/ncnt-geoopt.out | tail -1 | awk '{print $7}'" \
                % (site+1,xyz.symbols[site], CP2K_OUT_PATH, d)
            spin = float(subprocess.check_output(str5,shell=True))
            mu.append(spin)

            # Band gap
            str6 = "grep 'LUMO gap' %s/hybrid_refs/%s/ncnt-geoopt.out | tail -2 | awk '{print $7}' | sort -n | head -1" \
                % (CP2K_OUT_PATH,d)
            gap = float(subprocess.check_output(str6,shell=True))
            Egap.append(gap)

            # Dopant/vacancy concentration, site atomic number, multiplicity
            cN.append(float(len(nitro))/float(len(refopt)-len(hydro))*100)
            cV.append((224-len(refopt)+len(hydro))/224.*100)
            cH.append(float(len(hydro)+1)/float(len(refopt)-len(hydro))*100)
